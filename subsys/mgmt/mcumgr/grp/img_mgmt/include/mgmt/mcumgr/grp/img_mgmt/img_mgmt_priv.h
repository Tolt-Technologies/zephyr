...
#if defined(CONFIG_MCUBOOT_BOOTLOADER_USES_SHA512)
#define IMAGE_TLV_SHA		IMAGE_TLV_SHA512
#define IMAGE_SHA_LEN		64
#elif defined(CONFIG_MCUBOOT_BOOTLOADER_USES_SHA384)
#define IMAGE_TLV_SHA		IMAGE_TLV_SHA384
#define IMAGE_SHA_LEN		48
#else
